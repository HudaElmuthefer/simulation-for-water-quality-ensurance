...
% FIX: export at 300 dpi (journal requirement) instead of screen-resolution saveas
exportgraphics(gcf, 'figure5_rf_importance.png', 'Resolution', 300);

figure;
plot(oobError(model));
% FIX: title now matches the published Figure 6 caption ("learning curve"),
% instead of the internal debug title "Model Training Error"
title('Random Forest Out-of-Bag Learning Curve');
% FIX: export at 300 dpi (journal requirement) instead of screen-resolution saveas
exportgraphics(gcf, 'figure6_rf_learning_curve.png', 'Resolution', 300);